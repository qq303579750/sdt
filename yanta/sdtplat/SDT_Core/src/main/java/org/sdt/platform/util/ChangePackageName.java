...
public class ChangePackageName {
    ...
    public static void main(String[] args) {
        //processJavaFile("org.sdt","com.sdt");
        processJavaFile("com.sdt","org.sdt");
    }
    public static void processJavaFile(String oldPackage, String newPackage){  
        replaceFolderForJavaFile(new File(SDTPATH), oldPackage, newPackage);
        replacePackageForJavaFile(new File(SDTPATH), oldPackage, newPackage);
