...
public class PropertyHolder {
    private static final SDTLogger LOG = SDTLoggerFactory.getSDTLogger(PropertyHolder.class);
    ...
    /**
     * 本方法中的日志只能输出中文，因为SDTLoggerImpl中默认指定输出中文
     * 只有配置项加载完毕，调用了指定日志输出语言方法LOG.setLocale(getLogLanguage())
     * 之后，配置的日志输出语言才会生效
     */
    private static void init() {
            String systemConfig="/org/sdt/config.properties";
            String localConfig="/config.local.properties";
            String dbConfig="/org/sdt/db.properties";
