...
public class GzipFilter extends Filter {
    private static final SDTLogger LOG = SDTLoggerFactory.getSDTLogger(GzipFilter.class);
    /**
...
class GenericResponseWrapper extends HttpServletResponseWrapper implements Serializable {
    ...
    private static final SDTLogger LOG = SDTLoggerFactory.getSDTLogger(GenericResponseWrapper.class);
...
class ResponseUtil {
    private static final SDTLogger LOG = SDTLoggerFactory.getSDTLogger(ResponseUtil.class);
...
abstract class Filter implements javax.servlet.Filter {
    ...
    private static final SDTLogger LOG = SDTLoggerFactory.getSDTLogger(Filter.class);
