    ...
    var authorityNameSpace = 'checkMgt/rewardInOpt';
    var authorityAction = 'reward-in-opt-check';
    ...
    ModifyModel = function() {
        return {
            ...
            show: function(model) {
            	...
            	ModifyBaseModel.show('劳动报酬提单详细信息', 'salesInfo', 800, 500, this.getItems(model),model);
            }
        };
    } (); 
