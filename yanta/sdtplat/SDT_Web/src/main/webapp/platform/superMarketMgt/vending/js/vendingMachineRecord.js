 ...
 */
    ...
    var authorityAction = 'vending-machine-record';
...
// 				{header: "发放状态", width: 20, dataIndex: 'FFZT', sortable: true,
//					renderer:function(value, cellmeta, record){
//	 					if(value=='未发放'){
//	 						return "<span style='color:RGB(221,0,0);'>"+value+"</span>";
//	 					}else{
...
// 				},
            ...
            show: function(){
            	...
            	GridBaseModel.initQueryParma = function(){
                    ...
                    GridBaseModel.queryString=" and zdlx='点购台'";
...
//        			}
                ...
                GridBaseModel.exportDetail = function(){
                	if(undefined==GridBaseModel.storeURLParameter){
                		GridBaseModel.storeURLParameter="";
                    }
                    parent.Ext.Ajax.request({
                        url : contextPath+'/superMarketMgt/sales-info-detail!export.action',
                        waitTitle: '请稍等',
                        waitMsg: '正在导出数据……',
                        timeout:600000,
                        method : 'POST',
