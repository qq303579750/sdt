 ...
 */
    ...
    var authorityAction = 'under-product';
    ...
    GridModel = function() {
        return {
            ...
            shangjia: function (){
                ...
                parent.Ext.MessageBox.confirm("请确认","确实要上架吗？",function(button,text){
                    if(button == "yes"){
                    	GridModel.updatasj(idList.join(','));
                    }
                });
            },
            updatasj: function(ids){
                parent.Ext.Ajax.request({
                    url : contextPath+'/'+namespace+'/'+action+'!updataSJ.action?time='+new Date().toString(),
                    waitTitle: '请稍等',
                    waitMsg: '正在上架商品……',
                    params : {
                        ids : ids
            ...
            getGrid: function(){
                ...
                GridBaseModel.initQueryParma= function(){
                    ...
                    GridBaseModel.queryString=" and sfsj='否'";
                ...
                var commands=["create","delete","update","update","detail","search","query","export"];
                var tips=['增加','删除','修改','上架','详细','高级搜索','显示全部','导出'];
                var callbacks=[GridBaseModel.create,GridBaseModel.remove,GridBaseModel.modify,GridModel.shangjia,GridBaseModel.detail,GridBaseModel.advancedsearch,GridBaseModel.showall,GridBaseModel.exportData];
