...
var authorityNameSpace = 'telMgt/telRechargeRpt';
var authorityAction = 'tel-detail-rpt';
...
var czlxStore=new Ext.data.SimpleStore({
	fields:['text'],
    data:  [['新办电话卡'],['补办电话卡'],['话费充值']]
});
...
},
{
    ...
    editable:false
		...
		reportShow : function(param) {
			...
			condtion = condtion + ' and XFLX=\'电话费\'';
    		...
    		var czlx = Ext.getCmp('czlx'+param).getValue();
    		if (czlx != undefined && czlx != ''){
    			condtion = condtion + ' and bz=\'' + czlx+'\'';
    		}
    		...
    		this.report_url = ReportFunc.getReportUrl("billdetail.rptdesign",title,infoLeft,infoRight,condtion);
