 ...
 */
    ...
    var action='transfer-info-detail';
    ...
    AdvancedSearchModel = function() {
        return {
            ...
            callback : function(){               
                    ...
                    //调拨单ID
                    var search_DBDID=parent.Ext.getCmp('search_DBDID').getValue();
                    if(search_DBDID.toString()!=""){
                        search_DBDID=' +id:'+search_DBDID;
                        data.push(search_DBDID);
                    }    				
                    ...
                    AdvancedSearchBaseModel.search(data, "TransferInfoDetail");
            },
            ...
            show: function() {
                ...
                AdvancedSearchBaseModel.show('高级搜索','transferInfoDetail', 800, 152, this.getItems(), this.callback);
            }
        };
    } ();
    //添加模型信息
    CreateModel = function() {
        return {
            ...
            show: function() {
                ...
                CreateBaseModel.show('添加库存调拨明细', 'transferInfoDetail', 800, 216, this.getItems());
            }
        };
    } ();
    //修改模型信息
    ModifyModel = function() {
        return {
            ...
            show: function(model) {
                ...
                ModifyBaseModel.show('修改库存调拨明细', 'transferInfoDetail', 800, 216, this.getItems(model),model);
            }
        };
    } ();
    //显示模型详细信息
    DisplayModel = function() {
        return {
            ...
            show: function(model) {
                ...
                DisplayBaseModel.show('库存调拨明细详细信息', 'transferInfoDetail', 800, 216, this.getItems(model));
            }
        };
    } ();       
    //表格
        ...
        return {
            ...
            getColumns: function(){
                ...
                {header: "编号", width: 10, dataIndex: 'id', sortable: true},
 				{header: "调拨单ID", width: 20, dataIndex: 'DBDID_id', sortable: true},
