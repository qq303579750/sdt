    ...
    ReportOpt = function() {
    	return {
    		...
    		reportShow : function() {
        		...
        		condition = condition + " and (JYSJ>='"+ beginDate + "' and " + "JYSJ<='"+endDate + "') and JYLX in ('现金充值','','汇款充值','劳动报酬','生活补贴')";
        		...
        		var url = "<iframe src='" + parent.getURL() + "/frameset?__report=grsz.rptdesign"+
