    ...
    ReportOpt = function() {
    	return {
    		...
    		reportShow : function() {
        		...
        		condition = condition + " and (JYSJ>='"+ beginDate + "' and " + "JYSJ<='"+endDate + "') and JYLX in ('点购台订单','电话费','医疗消费','材料费','报刊费','其他')";
        		//title = "个人资金流动明细—"+personid+"-"+xm;
        		if(prisonName.indexOf("渭南")>0){
        			title = prisonName+"["+xm+"("+jsbh+")]购物记录";
        		}
        		else{
        		...
        		var url = "<iframe src='" + parent.getURL() + "/frameset?__report=grxz.rptdesign"+
