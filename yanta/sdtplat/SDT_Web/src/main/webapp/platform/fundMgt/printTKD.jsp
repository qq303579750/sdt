...
x.innerHTML='\
	<table border="2" width="700" align="center" cellspacing="0" cellpadding="4" style="border: #000000 double;font-size:15px; border-collapse:collapse; ">\
	  <caption style="color:red; font-size:20px; padding:10px; font-weight:bold;">'+model.subType+'回执单</caption>\
	  <tr style="border: #000000 1px slide;">\
	  <th style="border: #000000 1px slide;">退款单位</th>\
	  <td style="border: #000000 1px slide;" colspan=5>'+model.prisonName+'</td>\
	  <th style="border: #000000 1px slide;">单据号：</th>\
	  ...
	  <tr style="border: #000000 1px slide;">\
	  <th style="border: #000000 1px slide;">出生日期</th>\
	  <td style="border: #000000 1px slide;">'+model.CSRQ+'</td>\
	  <th style="border: #000000 1px slide;">人员籍贯</th>\
	  <td style="border: #000000 1px slide;">'+model.RYJG+'</td>\
	  <th style="border: #000000 1px slide;">退款时间</th>\
	  ...
	  <tr style="border: #000000 1px slide;">\
	  <th style="border: #000000 1px slide;">退款员</th>\
