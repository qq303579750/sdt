 ...
 * 
 */
var authorityNameSpace = 'hospitalMgt/hospitalRechargeRpt';
var authorityAction = 'hospital_detail_rpt';
...
},
{
    ...
    editable: false  		
		...
		reportShow : function(param) {
			...
			condtion = condtion + ' and XFLX=\'医疗消费\'';
    		...
    		//报表肩膀信息
        	title = prisonName +"医疗消费汇总";
        	infoRight = "";
        	//infoRight = '下账类型：'+xflxstr +'   操作员：'+czystr +'   所属监区：'+jqmctr;
    		
    		this.report_url = ReportFunc.getReportUrl("changetail.rptdesign",title,infoLeft,infoRight,condtion);
