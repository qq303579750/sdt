 ...
 */
    ...
    var authorityAction ='charge-opt-check';
  ...
  //显示模型详细信息
    ModifyModel = function() {
        return {
            ...
            show: function(model) {
            	ModifyModel.getLabelWidth=function(){
                    return 90;
                };
                ...
                ModifyBaseModel.submitModify= function(form){
                	...
                	parent.Ext.Ajax.request({
                         url : contextPath+'/'+namespace+'/'+action+'!cancelRecord.action?model.RYBH='+model.RYBH+'&model.id='+model.id+'&model.XM='+model.XM,
                         waitTitle: '请稍等',
                         waitMsg: '正在审核……',
                         params: {
                        	 shjg:shjg
                ...
                ModifyBaseModel.show('取消审核', 'cardRechargeRecord', 900, 400, this.getItems(record),record);
            }
        };
    } ();    
    ...
    GridModel = function() {
        return {
            ...
            show: function(){
                ...
                var tips=['审核','详细(D)','高级搜索(S)','显示全部(A)','导出(E)'];
