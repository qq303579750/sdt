        ...
        getPanel: function (data) {
            ...
            this.grid = new parent.Ext.grid.GridPanel({
                ...
                columns: [//配置表格列
                    ...
                    {
                        header: "当前余额", width: 30, dataIndex: 'YE', sortable: true, renderer: function (value) {
                            return PubFunc.MoneyFormat(value);
                        }
                    },
                    {header: "所属月份", width: 30, dataIndex: 'SSYF', sortable: true},
                    {
                        header: "充值金额", width: 30, dataIndex: 'CZJE', sortable: true, renderer: function (value) {
                            return PubFunc.MoneyFormat(value);
                        }
                    },
                                ...
                                var columns = [
                                    {
                                        ...
                                        renderer: function (value) {
                                            return PubFunc.getPrisonInfo(value, 'text');
                                        }
                                    },
                                    ...
                                    {header: "姓名", width: 8, dataIndex: 'XM', sortable: true},
                                    {
                                        ...
                                        dataIndex: 'CZJE',
                                        sortable: true,
                                        css: PubCSS.noBlankField(3),
                                        editor: PubFunc.getNumberField(true, 2, false, 0),
                                        renderer: function (value) {
                                            return PubFunc.MoneyFormat(value);
                                        }
                                    },
...
GridModel = function () {
    return {
        ...
        getColumns: function () {
            var columns = [
                {header: "编号", width: 15, dataIndex: 'id', sortable: true},
                {
                    ...
                    hidden: true,
                    renderer: function (value) {
                        return PubFunc.getPrisonId(value, 'value');
                    }
                },
                ...
                {
                    header: "合计金额", width: 20, dataIndex: 'HJJE', sortable: true, renderer: function (value) {
                        return PubFunc.MoneyFormat(value);
                    }
                },
                {
                    header: "操作员", width: 20, dataIndex: 'CZYBH_id', sortable: true, renderer: function (value) {
                        return PubFunc.getUserInfo(value, 'realName');
                    }
                },
                {
                ...
                },
                {
                    ...
                    hidden: true,
                    renderer: function (value) {
                        return PubFunc.getUserInfo(value, 'orgname');
                    }
                },
                {
                    header: "审核人", width: 20, dataIndex: 'SHR_id', sortable: true, renderer: function (value) {
                        return PubFunc.getUserInfo(value, 'realName');
                    }
                },
                {
        ...
        show: function () {
            ...
            var tips = ['监区发放', '批量导入', '重新提单', '详细(D)', '高级搜索(S)', '显示全部(A)', '导出(E)'];
...
Ext.onReady(function () {
    ...
    PrisonInfoStore.load({
        callback: function () {
            PubFunc.loadCallback(isload, 0, func)
        }
    });
    UserStore.load({
        callback: function () {
            PubFunc.loadCallback(isload, 1, func)
        }
    });
});