    ...
    AdvancedSearchModel = function() {
        return {
            ...
            callback : function(){               
                    ...
                    var search_orgName=parent.Ext.getCmp('model.org.id').getValue();
                    if(search_orgName!=""){
                        search_orgName='org.id:eq:'+search_orgName;
    ...
    GridModel = function() {
        return {
            ...
            getColumns: function(){
                ...
                {header: "所属监区", width: 40, dataIndex: 'SSJQ_JQMC', sortable: true},                                               
				{header: "拥有角色", width: 40, dataIndex: 'roles', sortable: true},
				{header: "拥有岗位", width: 40, dataIndex: 'positions', sortable: true,hidden:true},
				{header: "组织架构", width: 40, dataIndex: 'orgName', sortable: true,hidden:true},
				{header: "联系方式", width: 40, dataIndex: 'phone', sortable: true},
				{header: "联系地址", width: 40, dataIndex: 'address', sortable: true,hidden:true},
				{header: "描述", width: 40, dataIndex: 'des', sortable: true,hidden:true,editor:new Ext.form.TextField()}
                            ];
                return columns;           
            },
            getGrid: function(){
