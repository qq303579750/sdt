...
x.innerHTML='\
	<table border="2" width="700" align="center" cellspacing="0" cellpadding="4" style="border: #000000 double;font-size:15px; border-collapse:collapse; ">\
	  <caption style="color:red; font-size:20px; padding:10px; font-weight:bold;">下账消费回执单</caption>\
	  ...
	  <td style="border: #000000 1px slide;">'+model.printId+'</td>\
	  </tr>\
	  <tr>\
	  <tr style="border: #000000 1px slide;">\
	  ...
	  <td style="border: #000000 1px slide;" colspan=3>'+model.xfsj+'</td>\
	  <th style="border: #000000 1px slide;">备注</th>\
	  <td style="border: #000000 1px slide;" colspan=3>'+model.BZ+'</td>\
	  </tr>\
	  <tr style="border: #000000 1px slide;">\
	  ...
	  <tr style="border: #000000 1px slide;">\
	  <th style="border: #000000 1px slide;">下账员</th>\
