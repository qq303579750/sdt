    ...
    var authorityAction = 'subsidy-in-opt-check';
    ...
    AdvancedSearchModel = function(){
        ...
        show: function() {
            ...
            AdvancedSearchBaseModel.show('高级搜索','subsidyApplay', 800, 230, this.getItems(), this.callback);
        }
    	};
    }();
    //填写审核信息
    ModifyModel = function() {
        return {
            ...
            show: function(model) {
            	...
            	ModifyBaseModel.show('生活补贴提单详细信息', 'salesInfo', 800, 500, this.getItems(model),model);
            }
        };
    } (); 
