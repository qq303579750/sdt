...
var authorityAction = 'refund_rpt';
...
ReportOpt = function() {
	return {
		...
		reportShow : function(param) {
			...
			var infoLeft;
			var infoRight;
			var condtion = " where r.tableId=c.id and r.tablename='cardrechargerecord' and c.SHZT='已通过' and c.czlx='离监退款' ";
			var reportfile;
    		...
    		//报表肩膀信息
    		infoRight = '经办人：'+czystr +'   所属监区：'+jqmctr;
    		
    		this.report_url = ReportFunc.getReportUrl("ljtkSts.rptdesign",title,infoLeft,infoRight,condtion);
