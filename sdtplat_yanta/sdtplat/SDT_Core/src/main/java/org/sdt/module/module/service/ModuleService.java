...
import org.sdt.module.security.service.PrivilegeUtils;
...
public class ModuleService {
    private static final SDTLogger LOG = SDTLoggerFactory.getSDTLogger(ModuleService.class);
    ...
    public static List<String> getCommandPath(Command command) {
        ...
        //SDT是支持任意多级的模块嵌套的，虽然目前的DEMO中只有两级
        //对于以下的路径来说：
        //http://sdt.net/security/user!query.action
        //query是命令
        //user是模块
        //security也是模块
