package org.sdt.platform.struts;
 ...
 * </p>
 */
public class SDTPackageBasedActionConfigBuilder implements ActionConfigBuilder {

    private static final Logger LOG = LoggerFactory.getLogger(SDTPackageBasedActionConfigBuilder.class);
     ...
     */
    @Inject
    public SDTPackageBasedActionConfigBuilder(Configuration configuration, Container container, ObjectFactory objectFactory,
