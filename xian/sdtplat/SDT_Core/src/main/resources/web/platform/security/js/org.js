...
GridModel = function() {
    return {
        ...
        getGrid: function(){
            ...
            var commands=["create","delete","updatePart","export"];
            var tips=['增加','删除','修改','导出'];
            var callbacks=[GridBaseModel.create,GridBaseModel.remove,GridBaseModel.modify,GridBaseModel.exportData];
