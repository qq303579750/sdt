...
<script type="text/javascript" src="<%=contextPath%>/platform/js/RowExpander.js"></script>
<script type="text/javascript" src="<%=contextPath%>/platform/js/PersonPublicFun.js"></script>
<script type="text/javascript" src="<%=contextPath%>/platform/js/PrisonPublicFun.js"></script>
<script type="text/javascript" src="<%=contextPath%>/platform/js/SubsidyApplyFun.js"></script>
<script type="text/javascript" src="<%=contextPath%>/platform/js/medicalFun.js"></script>
<script type="text/javascript" src="<%=contextPath%>/platform/js/BonusApplyFun.js"></script>
<script type="text/javascript" src="<%=contextPath%>/platform/js/personInfoGrid.js"></script>
<script type="text/javascript" src="<%=contextPath%>/platform/js/productInfoGrid.js"></script>
