...
public class AddLicenceForSourceFile {
    ...
    private static final String SDTPATH="D:\\Workspaces\\NetBeansProjects\\SDT";
...
"   SDT - Development Platform\n" +
"   Copyright (c) 2013, SDTDJS@Kevin 303579750@qq.com\n" +
"   \n" +
"   This program is free software: you can redistribute it and/or modify\n" +
"   it under the terms of the GNU General Public License as published by\n" +
"   the Free Software Foundation, either version 3 of the License, or\n" +
...
"--%>";
    ...
    public static void processJavaFile(){
        ...
        addLicenceForJavaFile(new File(SDTPATH),JAVALICENSE);
    ...
    public static void processJspFile(){
        ...
        addLicenceForJspFile(new File(SDTPATH),JSPLICENSE);
    ...
    public static void processJsFile(){
        ...
        addLicenceForJsFile(new File(SDTPATH),JSLICENSE);
