...
public class ElasticSearchLogHandler implements LogHandler{
    private static final SDTLogger LOG = SDTLoggerFactory.getSDTLogger(ElasticSearchLogHandler.class);
    ...
    public static void main(String[] args){
        ...
        //curl  -XGET http://localhost:9200/sdt_for_log/_search?pretty=true&q=ysc
    }
}
