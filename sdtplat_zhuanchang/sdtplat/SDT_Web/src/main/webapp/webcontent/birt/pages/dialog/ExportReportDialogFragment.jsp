			...
			<%
				...
				{					
					if ( !ParameterAccessor.PARAM_FORMAT_HTML.equalsIgnoreCase( supportedFormats[i] )
							&& !supportedFormats[i].equals("odp")
							&& !supportedFormats[i].equals("ods")
							&& !supportedFormats[i].equals("odt")
							&& !supportedFormats[i].equals("postscript")
							&& !supportedFormats[i].equals("xls_spudsoft"))
					{
			%>
