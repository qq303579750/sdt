    ...
    return {
        ...
        getColumns: function () {
            ...
            var columns = [
                ...
                {header: "银行卡号", width: 20, dataIndex: 'YHKH', sortable: true},
                ...
                {
                    header: "所属监区", width: 20, dataIndex: 'SHJQ_id', sortable: true, renderer: function (value) {
                ...
                },
                {
                    ...
                    hidden: true,
                    renderer: function (value) {
                        return PubFunc.getSupermarket(value, 'text');
                    }
                },
                {
                    header: "香烟限额等级",
                    ...
                    hidden: true,
                    renderer: function (value) {
                        return PubFunc.getSmoke(value, 'text');
                    }
                },
                {
                    header: "电话限额等级",
                    ...
                    hidden: true,
                    renderer: function (value) {
                        return PubFunc.getPhone(value, 'text');
                    }
                },
                {
                    header: "单次限额等级",
                    ...
                    hidden: true,
                    renderer: function (value) {
                        return PubFunc.getSingle(value, 'text');
                    }
                },
        ...
        show: function () {
            ...
            GridBaseModel.getSearchModel = function () {
                return true;
            };
...
Ext.onReady(function () {
    ...
    smokeStore.load({
        callback: function () {
            PubFunc.loadCallback(isload, 2, func)
        }
    });
    phoneStore.load({
        callback: function () {
            PubFunc.loadCallback(isload, 3, func)
        }
    });
    singleStore.load({
        callback: function () {
            PubFunc.loadCallback(isload, 4, func)
        }
    });
});