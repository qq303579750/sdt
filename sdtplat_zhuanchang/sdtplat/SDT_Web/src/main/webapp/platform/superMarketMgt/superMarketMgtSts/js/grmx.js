...
ReportOpt = function() {
	return {
		...
		reportShow : function() {
    		...
    		title = "点购台消费记录—"+personid+"-"+xm;
    		condition = condition + ' group by xssj,HPBM ';
    		...
    		var url = "<iframe src='" + parent.getURL() + "/frameset?__report=grmx.rptdesign"+
