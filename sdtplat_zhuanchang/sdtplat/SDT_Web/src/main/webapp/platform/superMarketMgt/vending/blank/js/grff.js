	...
	return {
		...
		reportShow : function() {
    		...
    		if(flmc!=undefined&&flmc!=''){
    			condition = condition + ' and detail.hpfl in (';
    		...
    		title = prisonName+"("+jqmc+")"+zdlx+"个人货品分发单";
    		...
    		if(prison.indexOf("渭南")>0){
    			url = "<iframe src='" + parent.getURL() + "/frameset?__report=grff_jsh.rptdesign"+
    		...
    		}else if(prison.indexOf("华山")>0){
    			url = "<iframe src='" + parent.getURL() + "/frameset?__report=grff_qz.rptdesign"+
    			"&title="        +encodeURI(title)+
    			"&infoLeft="     +encodeURI(infoLeft)+
    			"&infoRight="    +encodeURI(infoRight)+
    			"&condition="    +encodeURI(condition)+" group by RYBH,XM"+
    			...
    			url = "<iframe src='" + parent.getURL() + "/frameset?__report=grff.rptdesign"+
    			"&title="        +encodeURI(title)+
    			"&infoLeft="     +encodeURI(infoLeft)+
    			"&infoRight="    +encodeURI(infoRight)+
    			"&condition="    +encodeURI(condition)+" group by RYBH,XM"+
